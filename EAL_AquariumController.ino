...
void TestNRMem(){
	...
	auto feederAcc = AccessoryType::Feeder;
	auto doserAcc = AccessoryType::DryDoser;
	RTCExt::SetRunEvery(2, feederAcc);
	RTCExt::SetRunEvery(3, doserAcc);

	RTCExt::UpdateNextRun(feederAcc);
	RTCExt::UpdateNextRun(doserAcc);
	...
	RTCExt::SetRunEvery(5, feederAcc);
	RTCExt::SetRunEvery(6, doserAcc);
	...
	//
	//_feedInfo.AccType = accType;
	//_feedInfo.CountDown = 0L;
	//_feedInfo.LastRun = 0L;
	//_feedInfo.NextRun = 0L;
	//_feedInfo.RunEvery = 0L;
	//_feedInfo.ShakesOrTurns = (short)0;
	//
	...
	//_doseInfo.AccType = accType2;
	//_doseInfo.CountDown = 0L;
	//_doseInfo.LastRun = 0L;
	//_doseInfo.NextRun = 0L;
	//_doseInfo.RunEvery = 0L;
	//_doseInfo.ShakesOrTurns = (short)0;
